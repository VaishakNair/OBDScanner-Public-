 ...
 */
class Parameter34EQ(context: Context, viewModel: ViewModel?, gaugeType: String? = null) : BaseParameter(
    context, viewModel, pid = "341\r", gaugeUnit = "Equivalence Ratio - B1S1",
    ticks = listOf(0f, 0.5f, 1.0f, 1.5f, 2.0f),
    min = 0f, max = 2f,
    parameterName = "Equivalence ratio - B1S1",
    ...
    override fun calculateValue(response: Float) {
        ...
        Log.i(APP_NAME, "Equivalence ratio (Bank 1 Sensor 1): $value")
    }

    override fun toString(): String {
        return "${context.getString(R.string.equi_ratio_b1_s1)}: $valueString"
    }
}