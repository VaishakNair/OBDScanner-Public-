...
/**
 * Wide range O2 sensor equivalence ratio (Bank 2 Sensor 4)
 */
class Parameter3BEQ(context: Context, viewModel: ViewModel?, gaugeType: String? = null) : BaseParameter(
    context, viewModel, pid = "3B1\r", gaugeUnit = "Equivalence Ratio - B2S4",
    ticks = listOf(0f, 0.5f, 1.0f, 1.5f, 2.0f),
    min = 0f, max = 2f,
    parameterName = "Equivalence ratio - B2S4",
    ...
    override fun calculateValue(response: Float) {
        ...
        Log.i(APP_NAME, "Equivalence ratio (Bank 2 Sensor 4): $value")
    }

    override fun toString(): String {
        return "${context.getString(R.string.equi_ratio_b2_s4)}: $valueString"
    }
}