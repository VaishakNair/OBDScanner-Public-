...
/**
 * Wide range O2 sensor voltage (Bank 2 Sensor 1)
 */
class Parameter28(context: Context, viewModel: ViewModel?, gaugeType: String? = null) : BaseParameter(
    context, viewModel, pid = "281\r", gaugeUnit = "Oxygen Sensor - B2S1(V)",
