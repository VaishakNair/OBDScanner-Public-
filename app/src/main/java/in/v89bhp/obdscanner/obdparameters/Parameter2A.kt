...
/**
 * Wide range O2 sensor voltage (Bank 2 Sensor 3)
 */
class Parameter2A(context: Context, viewModel: ViewModel?, gaugeType: String? = null) : BaseParameter(
    context, viewModel, pid = "2A1\r", gaugeUnit = "Oxygen Sensor - B2S3(V)",
