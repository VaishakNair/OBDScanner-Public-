...
/**
 * Short term fuel trim (Bank 2 Sensor 4)
 */
class Parameter1B(context: Context, viewModel: ViewModel?, gaugeType: String? = null) : BaseParameter(
    context, viewModel, pid = "1B1\r", gaugeUnit = "STFT - B2S4(%)",
    ticks = listOf(-100f, -80f, -60f, -40f, -20f, 0f, 20f, 40f, 60f, 80f, 100f),
    min = -100f, max = 100f,
    parameterName = "STFT - B2S4", gaugeType = gaugeType
) {
    ...
    override fun calculateValue(response: Float) {
        ...
        Log.i(APP_NAME, "Short term fuel trim (Bank 2 Sensor 4): $value")
    }

    override fun toString(): String {
        return "${context.getString(R.string.stft_b2_s4)} ($unit): $valueString"
    }
}