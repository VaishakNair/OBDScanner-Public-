 ...
 */
class Parameter14(context: Context, viewModel: ViewModel?, gaugeType: String? = null) : BaseParameter(
    context, viewModel, pid = "141\r", gaugeUnit = "STFT - B1S1(%)",
    ticks = listOf(-100f, -80f, -60f, -40f, -20f, 0f, 20f, 40f, 60f, 80f, 100f),
    min = -100f, max = 100f,
    parameterName = "STFT - B1S1", gaugeType = gaugeType
) {
    ...
    override fun calculateValue(response: Float) {
        ...
        Log.i(APP_NAME, "Short term fuel trim (Bank 1 Sensor 1): $value")
    }

    override fun toString(): String {
        return "${context.getString(R.string.stft_b1_s1)} ($unit): $valueString"
    }
}