...
/**
 * Wide range O2 sensor current (Bank 2 Sensor 2)
 */
class Parameter39(context: Context, viewModel: ViewModel?, gaugeType: String? = null) : BaseParameter(
    context, viewModel, pid = "391\r", gaugeUnit = "Oxygen Sensor - B2S2(mA)",
