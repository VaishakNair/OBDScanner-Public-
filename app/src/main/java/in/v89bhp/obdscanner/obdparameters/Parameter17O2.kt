...
/**
 * O2 sensor voltage (Bank 1 Sensor 4)
 */
class Parameter17O2(context: Context, viewModel: ViewModel?, gaugeType: String? = null) : BaseParameter(
    context, viewModel, pid = "171\r", gaugeUnit = "Oxygen Sensor - B1S4(V)",
    ticks = listOf(0f, 0.1f, 0.2f, 0.3f, 0.4f, 0.5f, 0.6f, 0.7f, 0.8f, 0.9f, 1f, 1.1f, 1.2f, 1.3f),
    min = 0f, max = 1.3f,
    parameterName = "Oxygen sensor - B1S4",
    ...
    override fun calculateValue(response: Float) {
        ...
        Log.i(APP_NAME, "O2 sensor (Bank 1 Sensor 4) ($unit): $value")
    }

    override fun toString(): String {
        return "${context.getString(R.string.oxygen_sensor_b1_s4)} ($unit): $valueString"
    }
}