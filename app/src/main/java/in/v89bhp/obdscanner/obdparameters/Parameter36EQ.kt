...
/**
 * Wide range O2 sensor equivalence ratio (Bank 1 Sensor 3)
 */
class Parameter36EQ(context: Context, viewModel: ViewModel?, gaugeType: String? = null) : BaseParameter(
    context, viewModel, pid = "361\r", gaugeUnit = "Equivalence Ratio - B1S3",
    ticks = listOf(0f, 0.5f, 1.0f, 1.5f, 2.0f),
    min = 0f, max = 2f,
    parameterName = "Equivalence ratio - B1S3",
    ...
    override fun calculateValue(response: Float) {
        ...
        Log.i(APP_NAME, "Equivalence ratio (Bank 1 Sensor 3): $value")
    }

    override fun toString(): String {
        return "${context.getString(R.string.equi_ratio_b1_s3)}: $valueString"
    }
}