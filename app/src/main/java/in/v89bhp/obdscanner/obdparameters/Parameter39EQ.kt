...
/**
 * Wide range O2 sensor equivalence ratio (Bank 2 Sensor 2)
 */
class Parameter39EQ(context: Context, viewModel: ViewModel?, gaugeType: String? = null) : BaseParameter(
    context, viewModel, pid = "391\r", gaugeUnit = "Equivalence Ratio - B2S2",
    ticks = listOf(0f, 0.5f, 1.0f, 1.5f, 2.0f),
    min = 0f, max = 2f,
    parameterName = "Equivalence ratio - B2S2",
    ...
    override fun calculateValue(response: Float) {
        ...
        Log.i(APP_NAME, "Equivalence ratio (Bank 2 Sensor 2): $value")
    }

    override fun toString(): String {
        return "${context.getString(R.string.equi_ratio_b2_s2)}: $valueString"
    }
}